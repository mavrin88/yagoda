    ...
    <div class="admin__container" @click="handleOutsideClick">
      <div class="admin-bill" v-if="order">
        <div class="admin-orders__top">
          <img class="edit-icon" @click="edit" src="/img/icon_edit.svg" alt="">
        <div></div>
...
<!--        </div>-->
        ...
        <div v-if="order.client" class="result__textarea">
          <div class="client-result__textarea">
            <p class="font-bold mb-1">{{ order.client.name }}</p>
        ...
        <div class="result__textarea">
          ...
          <div class="client-result__textarea">
            <textarea class="input-field" v-model="order.comment" maxlength="150" @input="debouncedSendComment" @blur="sendComment"></textarea>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    edit() {
      if (this.order && this.order.is_arbitrary_amount && this.order.is_arbitrary_amount === 1){
        this.$emit('back', this.order);
      }
      else{
